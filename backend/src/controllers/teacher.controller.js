...
const verifyEmail = async (Email, Firstname, createdTeacherId) => {
    ...
    try {
        ...
        const mailOptions = {
            ...
            html: `<div>
                <p>Hi ${Firstname}, verify your email</p>
...
const ForgetPassword=asyncHandler(async(req,res)=>{
    ...
    <p>${resetToken}</p>
    <p>Thank you for being a valued member of the meducation community. If you have any questions or need further assistance, please do not hesitate to contact our support team.</p>
    <p>Best regards,</p>
    <p>The meducation Team</p>`
